...
if __name__=='__main__':
    test_annotation_file = '../annotations/kaist_annotations_test20.json'
    user_submission_file = '../annotations/kaist_annotations_test20_2.json'
    phase_codename = 'dev'
